...
def parse_args():
    ...
    parser.add_argument('--output_path', type=str,
                    help='path to a folder to save results', required=True)
    parser.add_argument('--model_name', type=str,
                        help='name of a pretrained model to use',
                        choices=model_to_config.keys(), required=True)
...
def test_simple(args):
    ...
    encoder, depth_decoder = config.build_depth([192, 640])
    ...
    if os.path.isfile(args.image_path):
        ...
        raise Exception("Can not find args.image_path {} or args.output_path {}".format(args.image_path, args.output_path))
